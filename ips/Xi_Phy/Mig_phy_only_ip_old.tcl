...
#move the files in folder tb/ddr4_model/ to tb. This is done for simulation, as the auto gen sim scripts expects dram model files in tb folder
file copy  $IP_DIR/IP/mig_phy/mig_phy.srcs/sources_1/ip/$IP_NAME/tb/ddr_model/ddr4_sdram_model_wrapper.sv $IP_DIR/IP/mig_phy/mig_phy.srcs/sources_1/ip/$IP_NAME/tb/ddr_model/..
