...
file copy modelsim.ini $MEMCTRL_DIR/dram.ctrl.verilog/validation/tb_ddr4_mem_ch_top
file copy modelsim.ini $MEMCTRL_DIR/dram.ctrl.verilog/validation/tb_ddr4_ch_ctrl
