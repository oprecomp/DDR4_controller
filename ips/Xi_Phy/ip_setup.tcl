...
set MEMCTRL_DIR C:/MyFiles/chirag/memctrl

#Do not disturb
set IP_DIR $MEMCTRL_DIR/dram.ctrl.verilog/ips/Xi_Phy
set IP_PATH $MEMCTRL_DIR/dram.ctrl.verilog/ips/Xi_Phy/IP/mig_phy
set SYNTH_RES_PATH $MEMCTRL_DIR/dram.ctrl.verilog/runs/FPGA/SYNTH
set IMPL_RES_PATH $MEMCTRL_DIR/dram.ctrl.verilog/runs/FPGA/IMPL
set BIT_RES_PATH $MEMCTRL_DIR/dram.ctrl.verilog/runs/FPGA/BIT
set CONST_PATH $MEMCTRL_DIR/dram.ctrl.verilog/runs/FPGA/CONST
...
set SIM_LIB_PATH "$MEMCTRL_DIR/dram.ctrl.verilog/validation"
